				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="menu">
						<ul class="nav navbar-nav navbar-right">
                            ...
                            <li  class="active"  ><a href="admin_course.php">Courses</a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-offset-1 col-md-4">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h1 class="panel-title">Create Course</h1>
						</div>
				...
				<div class="col-md-offset-1 col-md-4">
					<div class="panel panel-primary">
						<div class="panel-heading">
							<h1 class="panel-title">Added Courses</h1>
						</div>
						<div class="panel-body">
							 <table class="table table-striped">
								...
								<tr>
									...
									<td><a href="delete_course.php?del=<?php echo $c_id; ?>" class="btn btn-danger btn-block">Delete</a></td>
